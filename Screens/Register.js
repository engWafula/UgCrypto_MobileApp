...
<StatusBar style='light' backgroundColor='#1A237E' />
     <Text style={{marginBottom:50,fontSize:25}}>Create a UG Crypto Account</Text>
<View style={styles.inputContainer}>
 ...
 onSubmitEditing={Register}
  onChangeText={text=>setImage(text)}/>
    ...
    <Button    buttonStyle={{backgroundColor:"#3F51B5"}} containerStyle={styles.button}  raised  title='Register'/>
